...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('DzKftu8gFv', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tkFrZ0pC0W', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JBR7k3JBkd', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('09wbIceTuj', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('81541ba8ea2cc5788129d8f35a5e6cc1f1357801')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('81541ba8ea2cc5788129d8f35a5e6cc1f1357801');
    }
        ...
        switch ($name) {
            ...
            case 'vich_uploader.mappings': $value = array(
                'post_images' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'\\app/../web/uploads/images/posts'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'user_images' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'\\app/../web/uploads/images/users'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '81541ba8ea2cc5788129d8f35a5e6cc1f1357801',
            'locale' => 'en',
            'app.path.post_images' => '/uploads/images/posts',
            'app.path.user_images' => '/uploads/images/users',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => '81541ba8ea2cc5788129d8f35a5e6cc1f1357801',
                        ...
                        'show' => array(
                            'fields' => array(
                                0 => array(
                                    'property' => 'image',
                                    'type' => 'image',
                                    'base_path' => '/uploads/images/posts',
                                ),
                            ),
                        ),
                        'form' => array(
                            ...
                            'fields' => array(
                                ...
                                9 => 'frenchDescription',
                                10 => 'frenchAvailable',
                                11 => 'frenchFacebookSharingAvailable',
                                12 => 'frenchFacebookUrlToShare',
                                13 => 'frenchTwitterSharingAvailable',
                                14 => 'frenchTwitterUrlToShare',
                                15 => 'frenchLinkedinSharingAvailable',
                                16 => 'frenchLinkedinUrlToShare',
                            ),
                        ),
                        'name' => 'Post',
                    ),
